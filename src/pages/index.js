...
import { LinkArrow } from "@/components/lcons";
...
export default function Home() {
  return (
    ...
    {/*หน้าแรก*/}
      <Head>
        <title>Profile developer</title>
        <meta name="description" content="Generated by create next app" />
      </Head>
      <TransitionEffect />
      <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
        <Layout className="pt-0 md:p-16 sm:first-letter:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col  items-center self-end lg:w-full lg:text-center ">
              <AnimatedText
                text="Turning Vision Into Reality with code And Desing."
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                ...
                <Link
                  ...
                  target={"_blank"}
                  className="ml-4 text-lg font-medium capitalize text-dark underline dark:text-light hover:dark:border-light md:text-base"
                >
                  Contact
                </Link>
              </div>
